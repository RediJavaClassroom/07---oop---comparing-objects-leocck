...
public class Step1_AppointmentTest {
    ...
    @Test
    void shouldDefineAppointmentClass() {
    ...
    @Test
    void shouldHaveDurationProperty() {
    ...
    @Test
    void shouldHaveLocationProperty() {
    ...
    @Test
    void shouldHaveGetterForDuration() {
    ...
    @Test
    void shouldHaveSetterForDuration() {
    ...
    @Test
    void shouldHaveGetterForLocation() {
    ...
    @Test
    void shouldHaveSetterForLocation() {
    ...
    @Test
    void shouldImplementComparableInterface() {
    ...
    @Test
    void shouldFollowNaturalOrderingByDateTime() {
