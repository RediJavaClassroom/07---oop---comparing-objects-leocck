...
public class Step3_CalendarServiceTest {
    ...
    @Test
    void shouldHaveCalendarsProperty() {
    ...
    @Test
    void shouldInitializeCalendarsProperty() {
    ...
    @Test
    void shouldHaveAddCalendarMethod() {
    ...
    @Test
    void shouldAddCalendarsToService() {
    ...
    @Test
    void shouldNotAddIdenticalCalendarsToService() {
    ...
    @Test
    void shouldHaveGetAppointmentsOrderByDateAndOwnerMethod() {
    ...
    @Test
    void shouldSortAppointmentsByDateAndOwner() {
